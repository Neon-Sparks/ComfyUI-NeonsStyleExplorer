...
| `neons_style_explorer_roll.json` | The dice entry with `roll_scope: missing preview`, seed control set to randomize — a new style every run, handy for filling the gallery |
